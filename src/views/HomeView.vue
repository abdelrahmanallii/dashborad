   ...
   <div class="kt-container-fixed">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:gap-5">
     <div class="kt-card h-[25  0px] pt-3">
      ...
      <div v-if="homeData" class="kt-card-content py-1">
       <div
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{ homeData.storename }}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.internal_manager_name}}</span>
       </div>
      </div>
     ...
     <div v-if="homeData"  class="kt-card pt-3">
      ...
      <div class="kt-card-content py-1">
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.enabled_products}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.review_products}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.disabled_products}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
     ...
     <div v-if="homeData" class="kt-card pt-3">
      ...
      <div class="kt-card-content py-1">
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.pending_orders}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.on_hold_orders}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.shipped_orders}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
     ...
     <div v-if="homeData" class="kt-card pt-3">
      ...
      <div class="kt-card-content py-1">
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.weekly_selling?.sum || 0}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.month_selling?.sum || 0}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.total_selling?.sum || 0}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
     ...
     <div v-if="homeData" class="kt-card pt-3">
      ...
      <div class="kt-card-content py-1">
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.pending_refund}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.accepted_refund}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{homeData.cancelled_refund}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
