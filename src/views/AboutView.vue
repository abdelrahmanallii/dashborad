   ...
   <div class=" grow shrink-0 flex ps-2 lg:ps-5 pe-1 lg:pe-3" data-kt-scrollable="true" data-kt-scrollable-dependencies="#sidebar_header" data-kt-scrollable-height="auto" data-kt-scrollable-offset="0px" data-kt-scrollable-wrappers="#sidebar_content" id="sidebar_scrollable">
    ...
    <div class="kt-menu flex flex-col grow gap-1" data-kt-menu="true" data-kt-menu-accordion-expand-all="false" id="sidebar_menu">
     ...
     <div class="kt-menu-item here show" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
      <div class="kt-menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" tabindex="0">
       <span class="kt-menu-icon items-start text-muted-foreground w-[20px]">
        <img src="@/assets/icons/BuyerGuide.svg" alt="graph">
       </span>
       <span class="kt-menu-title text-sm font-medium text-foreground kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary">
        دليل الاجهزة
       </span>
     ...
     <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
      <div class="kt-menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" tabindex="0">
       <span class="kt-menu-icon items-start text-muted-foreground w-[20px]">
        <img src="@/assets/icons/Products.svg" alt="graph">
       </span>
       <span class="kt-menu-title text-sm font-medium text-foreground kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary">
        المنتجات
       </span>
     ...
     <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
      <div class="kt-menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" tabindex="0">
       <span class="kt-menu-icon items-start text-muted-foreground w-[20px]">
        <i class="ki-filled ki-parcel text-xl"></i>
       </span>
       <span class="kt-menu-title text-sm font-medium text-foreground kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary">
        الطلبات
       </span>
     ...
     <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
      <div class="kt-menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" tabindex="0">
       <span class="kt-menu-icon items-start text-muted-foreground w-[20px]">
        <img src="@/assets/icons/Orders.svg" alt="graph">
       </span>
       <span class="kt-menu-title text-sm font-medium text-foreground kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary">
        المرتجعات
       </span>
     ...
     <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
      <div class="kt-menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" tabindex="0">
       <span class="kt-menu-icon items-start text-muted-foreground w-[20px]">
        <img src="@/assets/icons/AccountReports.svg" alt="graph">
       </span>
       <span class="kt-menu-title text-sm font-medium text-foreground kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary">
          معاملات البائعين
       </span>
     ...
     <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
      <div class="kt-menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" tabindex="0">
       <span class="kt-menu-icon items-start text-muted-foreground w-[20px]">
        <img src="@/assets/icons/DT-Icon.svg" alt="graph">
       </span>
       <span class="kt-menu-title text-sm font-medium text-foreground kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary">
        تقارير الاجهزة
       </span>
     ...
     <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
      <div class="kt-menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" tabindex="0">
       <span class="kt-menu-icon items-start text-muted-foreground w-[20px]">
        <img src="@/assets/icons/Bundle.svg" alt="graph">
       </span>
       <span class="kt-menu-title text-sm font-medium text-foreground kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary">
        العروض
       </span>
 ...
 <div class="kt-wrapper flex grow flex-col">
   ...
   <div class="kt-container-fixed flex justify-between items-stretch lg:gap-4" id="headerContainer">
    ...
    <div class="flex gap-2.5  lg:hidden items-center -ms-1">
     <a class="shrink-0" href="html/demo1.html">
      <img class="max-h-[40px] w-[40px] dark:hidden " src="@/assets/Images/02.png"/>
      <img class="max-h-[50px] w-[70px] hidden dark:block" src="@/assets/Images/LOGO 02-01.png"/>
     </a>
  ...
  Team
     ...
     <div class="shrink-0" data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
      ...
      <div v-if="accountManager" class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
       <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
        <div class="flex items-center gap-2">
         <img alt="" class="size-9 shrink-0 rounded-full border-2 border-green-500"  :src="profilePicture"/>
         <div class="flex flex-col gap-1.5">
  ...
  <main class="grow pt-5" id="content" role="content">
   ...
   <div class="kt-container-fixed">
    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
     <div class="flex flex-col justify-center gap-2">
      <h1 class="text-xl text-primary font-medium leading-none">
       موبايل مصر
       <span class="font-bold text-secondary">بائعين</span>
      </h1>
     </div>
    </div>
   </div>
   ...
   <div class="kt-container-fixed">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:gap-5">
     <div class="kt-card h-[25  0px] pt-3">
      ...
      <div v-if="vendorData" class="kt-card-content py-1">
       <div
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{ vendorData.storename }}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.internal_manager_name}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
        class="kt-link text-md border-2 rounded-full border-orange-500 text-black hover:bg-orange-50 dark:text-white dark:hover:bg-orange-500 transition-colors px-8 py-1"
       >
        تعديل
       </button>
      </div>
     ...
     <div v-if="vendorWallet"  class="kt-card pt-3">
      ...
      <div class="kt-card-content 2xl:w-[250px] py-1">
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        <div class="flex items-center gap-3">
     ...
     <div v-if="vendorData"  class="kt-card pt-3">
      <div class="kt-card-header min-h-0 border-none">
       <div class="kt-card-heading">
      ...
      <div class="kt-card-content py-1">
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.enabled_products}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.review_products}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.disabled_products}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
     ...
     <div v-if="vendorData" class="kt-card pt-3">
      ...
      <div class="kt-card-content py-1">
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.pending_orders}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.on_hold_orders}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.shipped_orders}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
     ...
     <div v-if="vendorData" class="kt-card pt-3">
      ...
      <div class="kt-card-content py-1">
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.weekly_selling.sum || 0}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.month_selling.sum || 0}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.total_selling.sum || 0}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
     ...
     <div v-if="vendorData" class="kt-card pt-3">
      ...
      <div class="kt-card-content py-1">
       ...
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.pending_refund}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.accepted_refund}}</span>
       </div>
       <div
        class="flex items-center justify-between gap-2 py-2 border-b border-border border-soild last:border-none"
       >
        ...
        <span class="text-sm font-medium text-primary">{{vendorData.cancelled_refund}}</span>
       </div>
      </div>
      <div class="kt-card-footer border-none justify-center">
       <button
     ...
     <div class="kt-card h-[220px] pt-3">
      <div class="kt-card-header min-h-0 border-none">
       <div class="kt-card-heading">
   ...
   <!-- Container -->
   <div class="kt-container-fixed">
    <div class="grid w-full space-y-5 mt-5">
     <div class="kt-card">
      ...
      >
       <div v-if="products.length > 0" class="kt-table-wrapper">
        <table class="kt-table" data-kt-datatable-table="true">
         ...
         <tbody  v-for="product in products" :key="product.id" class="text-op">
          <tr>
           <td>
            <a
               href="#"
               class="text-sm font-medium whitespace-nowrap text-secondary"
           ...
           <td>
            <p class="text-sm font-medium ">{{product.visitors}}</p>
           </td>
           <td>
            <p class="text-sm font-medium ">{{product.visitors_cost}}</p>
           </td>
           <td>
            <p class="text-sm font-medium ">{{product.cart_variants_number}}</p>
           </td>
          </tr>
         </tbody>
        </table>
  ...
  <footer class="kt-footer">
   ...
   <div class="kt-container-fixed">
    <div class="flex flex-col md:flex-row justify-center md:justify-between items-center gap-3 py-5">
     <div class="flex-reverse order-2 md:order-1 gap-2 font-normal text-sm text-op">
      <span>
        All rights Reserved,COPYRIGHT © 2025
        <a class="text-secondary" href="https://mobitech.com.eg" rel="noopener" target="_blank" >
      MobiTech Integrated Solutions
      </a>
      </span>
     </div>
    </div>
...
<div class="kt-modal" data-kt-modal="true" id="report_user_modal">
 <div class="kt-modal-content max-w-[500px] top-[15%]">
  ...
  <div class="kt-modal-body p-0">
   ...
   <div class="text-2sm font-medium text-center  p-5">
...
<script setup lang="ts">
  ...
  import { useVendorData } from '@/api/VendorData'
  import { useProductsData } from '@/api/ProductsData'
  ...
  // استدعاء جميع البيانات عند تحميل الصفحة
  onMounted(async () => {
    try {
      // استدعاء بيانات vendor و المنتجات في نفس الوقت
      await Promise.all([
        fetchVendorData(),
